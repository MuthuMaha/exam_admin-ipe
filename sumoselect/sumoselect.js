        $(document).ready(function () {
            window.asd = $('.SlectBox').SumoSelect({ csvDispCount: 15, selectAll:true, captionFormatAllSelected: "Yeah, OK, so everything." });
            window.test = $('.testsel').SumoSelect({okCancelInMulti:true, captionFormatAllSelected: "Yeah, OK, so everything." });

            window.testSelAll = $('.testSelAll').SumoSelect({okCancelInMulti:true, selectAll:true });
            window.setter_college1 = $('.setter_college1').SumoSelect({okCancelInMulti:true, selectAll:true });
